...
### `src/data/fotos.js`
Armazena as 5 fotos das aves em **base64** diretamente no código.
Isso elimina dependência de CDN externo — as imagens funcionam offline.

```js
export const FOTOS = {
  arara:   'data:image/jpeg;base64,...',  // 51KB
  beija:   'data:image/jpeg;base64,...',  // 24KB
  pomba:   'data:image/jpeg;base64,...',  // 27KB
  gaviao:  'data:image/jpeg;base64,...',  // 58KB
  tainara: 'data:image/jpeg;base64,...',  // 35KB
};
```
...
*Aves & Trilhas · Ecoturismo 4.0 · Projeto VALORA · © 2025*
